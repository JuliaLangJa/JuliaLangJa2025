...
- 概要: Julia言語を共通言語として地域や分野の垣根を超えた交流を図ると共に、アジア初の『JuliaCon』開催に向けて国内コミュニティの結束を強化することを目的として、[JuliaTokyo](https://juliatokyo.connpass.com/)、[JuliaTokai](https://juliatokai.connpass.com/)、[Julia in Physics](https://ohno.github.io/julia_in_physics_2024/)の運営メンバー等による研究会『JuliaLang Japan 2025』を開催します。

## 招待講演

招待講演では、質疑応答を含む各20分で講演を行います。
...
- 題目: 東大１年生にjulia教えてみた
- 概要: 東京大学の全ての１年生は研究活動を体験する少人数チュートリアル講義である「初年次ゼミナール」を受講します。松井はjuliaを用いて線形代数・最適化・機械学習に入門する初年次ゼミナール講義を開講しました。その取り組みの内容を紹介し、大学１年生が線形代数の内容を実際に計算してみることの重要性や、そのためにjuliaが適しているのかどうかなどを議論します。
...
ライトニングトークでは、交代・質疑応答を含む各5分で講演を行います。
